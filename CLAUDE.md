...
- **Validation**: After finishing all changes, run the full validation suite in a single execution — `echo -e "\n=== RUNNING CARGO FMT ==="; cargo fmt --check; echo -e "\n=== RUNNING CARGO CLIPPY ==="; cargo clippy --all-targets --all-features -- -D warnings; echo -e "\n=== RUNNING CARGO TEST ==="; cargo test; echo -e "\n=== RUNNING CARGO DOC ==="; cargo doc --no-deps`
